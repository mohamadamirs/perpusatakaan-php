...
<li class="nav-item">
<a class="nav-link" href="?halaman=data_buku">
<i class="bi bi-book"></i> Daftar Buku
</a>
</li>

<li class="nav-item">
<a class="nav-link" href="?halaman=history_peminjaman">
...
<i class="bi bi-person"></i> <?= $_SESSION['nama_anggota']; ?>
</span>
...
Halo, <?= $_SESSION['nama_anggota']; ?>!
</h3>

<p class="text-muted mb-4">
Selamat datang di Perpustakaan SMK Karya Bhakti Brebes.
Silahkan melihat koleksi buku dan riwayat peminjaman Anda.
</p>
...
<p class="text-muted small">
Cek buku yang sedang dipinjam atau yang sudah dikembalikan.
</p>
